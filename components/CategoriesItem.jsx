...
const CategoriesItem = ({ img, title, viewers, tag1, tag2 }) => {
  return (
    <div className='p-2'>
      <Image src={img} width='261' height='350' alt='/' className='transform transition-all hover:-translate-x-2 hover:-translate-y-2 hover:drop-shadow-[8px_8px_0px_rgb(10,148,247)] cursor-pointer' />
      <div>
