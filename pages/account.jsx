  ...
  return (
    <div className='pt-[100px] flex flex-col max-w-[400px] w-full mx-auto p-4'>
     ...
     <p className='py-4'>Choose the account you want to sign in with.</p>
      ...
      <button className='flex items-center justify-center p-3 bg-blue-600 border border-blue-600 my-2' onClick={() => signIn()}><FaGoogle className='mr-2' />Sign in with <span className='font-bold pl-1'>Google</span></button>
    </div>
  )
}
